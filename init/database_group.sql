...
-- 2) Court
INSERT INTO
    court(id, name, address, phone, sportgroup_id)
VALUES
(
  1
...
-- 3) Product
INSERT INTO
    product(id, name, price, amount, court_id)
VALUES
(1, 'Sting Dau', 8000, 1, 1)
     , (2, 'Pepsi', 10000, 1, 1)
     , (3, '7Up', 10500, 1, 1);
...
-- 6) Field
INSERT INTO
    field(id, name, sport_type, court_id)
VALUES
(1, 'San 1', 1, 1)
     , (2, 'San 2', 1, 1)
     , (3, 'San 3', 1, 1);
...
-- 7) Time Slot
INSERT INTO
    timeslot(id, start_time, end_time, court_id)
VALUES
(
  1
...
-- 8) Field - Timeslot
INSERT INTO
    field_timeslot(field_id, ts_id, price, day_in_week)
VALUES
(1, 1, 50000, 1)
     , (1, 2, 50000, 1)
     , (1, 3, 55000, 1);
